module.exports = {
  name: "serverinfo",
  aliases: ["si", "info", "server"],
  category: "info",
  usage: "serverinfo",
  description: "tells information of current server",
  run: (client, message, bot, args, db) => {
    ...
    const embed = new Discord.RichEmbed()
      ...
      .addField(
        "Total | Humans | Bots",
        `${message.guild.members.size} | ${message.guild.members.filter(member => !member.user.bot).size}
